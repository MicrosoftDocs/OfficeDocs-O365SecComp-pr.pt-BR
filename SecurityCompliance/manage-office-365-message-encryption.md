 ...
 **Para gerenciar se deseja ou não permitir que os destinatários usar IDs sociais para entrar no portal OME**
 ...
 **Para gerenciar os senhas uma única vez ou não são geradas para OME**
 ...
 **Para gerenciar ou não o botão Protect aparece no Outlook na web**
 ...
 **Para gerenciar usuários de aplicativo de email do iOS ou não pode exibir mensagens protegidas pelo Office 365 Message Encryption**
...
2. Execute o cmdlet Set-ActiveSyncOrganizations com o parâmetro AllowRMSSupportForUnenlightenedApps da seguinte maneira:
  ...
  ```
    ...
    Por exemplo, para configurar o serviço não para enviar mensagens descriptografadas aos aplicativos unenlightened:
...
Se você optar por não permitir anexos de email descriptografada, que é o padrão, os usuários recebem uma mensagem informando que não têm os direitos para exibir o anexo. \* \* \* Inserir imagem?
 ...
 **Para gerenciar os anexos de email ou não sejam descriptografados no download de um navegador da web**
  
1. [Conecte-se ao Exchange Online usando o PowerShell remoto](http://technet.microsoft.com/library/jj984289%28v=exchg.150%29.aspx).
    
2. Execute o cmdlet Set-IRMConfiguration com o parâmetro DecryptAttachmentFromPortal da seguinte maneira:
 ...
 **Para desabilitar os novos recursos para o OME**
...
2. Se você habilitou o botão Protect no Outlook na web, desabilitá-lo executando o cmdlet Set-IRMConfiguration com o parâmetro SimplifiedClientAccessEnabled da seguinte maneira:
