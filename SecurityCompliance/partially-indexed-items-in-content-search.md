...
Para obter uma lista de propriedades de email e de documento que você pode pesquisar usando o recurso de pesquisa no &amp; centro de conformidade de segurança, consulte [keyword queries and Search Conditions for Content Search](keyword-queries-and-search-conditions.md).
...
- Conforme mencionado anteriormente, como as propriedades message e Document e seus metadados são indexados, uma pesquisa de palavra-chave poderá retornar resultados se essa palavra-chave aparecer nos metadados indexados. No enTanto, essa mesma pesquisa de palavra-chave pode não retornar o mesmo item se a palavra-chave só aparecer no conteúdo de um item com um tipo de arquivo sem suporte. Nesse caso, o item seria retornado como um item parcialmente indexado.
