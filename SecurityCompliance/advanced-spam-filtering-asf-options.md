...
|Estrutura ou IMarcas da estrutura em HTML  <br/> |Quando essa configuração estiver habilitada, qualquer mensagem que contenha a \<marca HTML frame\> ou \<iframe\> será marcada como spam. Essas marcas são usadas em sites ou em mensagens HTML para formatar a página para exibir texto ou elementos gráficos.  <br/> |X-CustomSpam: IFRAME ou FRAME em HTML  <br/> |
