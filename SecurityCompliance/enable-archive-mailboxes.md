...
## <a name="use-exchange-online-powershell-to-enable-or-disable-archive-mailboxes"></a>Use o PowerShell do Exchange Online para habilitar ou desabilitar as caixas de correio de arquivo morto

Você também pode usar o PowerShell do Exchange Online para habilitar o arquivamento de caixas de correio. O principal motivo para usar o PowerShell é que você pode ativar rapidamente a caixa de correio de arquivamento para todos os usuários em sua organização.

A primeira etapa é para se conectar ao PowerShell do Exchange Online. Para obter instruções, consulte [Connect to Exchange Online PowerShell](https://docs.microsoft.com/powershell/exchange/exchange-online/connect-to-exchange-online-powershell/connect-to-exchange-online-powershell).

Depois que você está conectado ao Exchange Online, você pode executar os comandos nas seções a seguir para habilitar ou desabilitar as caixas de correio de arquivo morto.
...
Execute o seguinte comando para habilitar a caixa de correio de arquivamento para todos os usuários em sua organização (cuja caixa de correio de arquivo morto atualmente não está habilitada).
...
Execute o seguinte comando para desabilitar a caixa de correio de arquivamento para todos os usuários em sua organização (cuja caixa de correio de arquivo morto está habilitada no momento).
