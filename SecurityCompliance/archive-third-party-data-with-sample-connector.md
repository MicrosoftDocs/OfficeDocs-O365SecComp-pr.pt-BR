...
---
# <a name="use-sample-connectors-to-archive-third-party-data-in-office-365-preview"></a>Usar conectores de amostra para arquivar dados de terceiros no Office 365 (versão prévia)

O recurso de conector de exemplo para arquivar dados de terceiros no Office 365 está em visualização.

Use um conector de exemplo no centro de conformidade do & de segurança no Office 365 para importar e arquivar dados de fontes de dados de terceiros, como Facebook, LinkedIn, Twitter e Bloomberg. Depois de configurar e configurar um conector de exemplo, ele se conecta à fonte de dados de terceiros (em uma base agendada), converte o conteúdo de um item em um formato de mensagem de email e, em seguida, importa esses itens para uma caixa de correio no Office 365.
...
> [!NOTE]
> Atualmente, somente o conector de amostra para páginas de negócios do Facebook está disponível para visualização. Mais exemplos de conectores serão disponibilizados em breve.
