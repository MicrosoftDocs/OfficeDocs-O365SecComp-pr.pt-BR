...
## Monitorar gerenciamento de registros
...
### [Exibição do uso do rótulo com análises de rótulo](label-analytics.md)
## Mais informações sobre gerenciamento de registros
...
#### [Usar um conector de exemplo para arquivar dados do Facebook no Office 365 (visualização)](archive-facebook-data-with-sample-connector.md)
...
### [Procurando na ATP do Microsoft 365](hunting.md)
