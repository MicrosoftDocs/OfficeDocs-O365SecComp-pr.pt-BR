...
Comece a configurar o S/MIME emitindo certificados e publicando-os no serviço de domínio do Active Directory local. Para obter mais informações sobre o gerenciamento de certificados no Exchange Server, consulte [certificados digitais e SSL](http://technet.microsoft.com/library/a9e2e08c-d46a-4135-a387-eb653212b676.aspx).
