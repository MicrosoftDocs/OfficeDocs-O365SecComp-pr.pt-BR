---
title: Relatórios inteligentes e insights no Centro de Conformidade e Segurança
ms.author: deniseb
author: denisebmsft
manager: laurawi
ms.date: 7/19/2018
...
|**Explorador de ameaças** (também chamado de Explorer) ou **detecções em tempo real** <br/> Malware suspeito detectado em emails e arquivos no Office 365  <br/> |No centro de &amp; conformidade de segurança, vá para **Threat Management** \> **Explorer** ou **detecções em tempo real**<br/> |[Explorador de ameaças (ou detecções em tempo real)](threat-explorer.md) <br/> |
...
[Monitorar a segurança e a conformidade no Office 365](monitor-security-and-compliance.md)
