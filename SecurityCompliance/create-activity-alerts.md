...
- Você pode usar a página **alertas** na segurança &amp; Centro de conformidade para criar alertas somente para atividades realizadas pelos usuários que estão listados no catálogo de endereços da sua organização. Você não pode usar esta página para criar alertas para atividades realizadas pelos usuários externos. 
    
- Ver as [informações mais](#more-information) seção para obter uma lista de cenários comuns (e a atividade específica para monitorar) que você pode criar alertas para. 
    
- Você pode criar alertas para as mesmas atividades que você pode pesquisar no log de auditoria do Office 365. 
...
3. No painel esquerdo, clique em **alertas**e, em seguida, clique em **Gerenciar alertas**.
    
4. Na página **alertas de atividade** , clique em **Adicionar um alerta**.
    
    ![Adicionar um alerta de atividade](media/53888bd5-9fa2-4398-8ccc-1a9dc72517ac.png)
  
5. Preencha os campos a seguintes para criar um alerta:
    ...
    c. **Enviar este alerta quando** - Click **Enviar este alerta quando** e defina esses dois campos:
...
3. No painel esquerdo, clique em **alertas**e, em seguida, clique em **Gerenciar alertas de atividade**.
    
4. Na lista de alertas para sua organização, clique no alerta que você deseja desativar.
    
5. Na página **Editar alerta** , clique o switch de alternância **em** para alterar o status para **Desativar**e, em seguida, clique em **Salvar**.
