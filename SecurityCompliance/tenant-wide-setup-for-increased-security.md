...
|***Autenticação de email*** <br/> |Sim  <br/> |Autenticação de email usa um sistema de nome de domínio (DNS) para adicionar informações verificáveis para mensagens de email sobre o remetente de um email. O Office 365 configura a autenticação de email para seu domínio padrão (onmicrosoft.com), mas os administradores do Office 365 também podem usar a autenticação de email para domínios personalizados. Três métodos de autenticação são usados:<br/> <br> &ensp;&ensp;• Estrutura de política do remetente (ou SPF).<br/>&ensp;&ensp;&ensp;&ensp;-Para a instalação, consulte [Configurar SPF no Office 365 para ajudar a impedir a falsificação](set-up-spf-in-office-365-to-help-prevent-spoofing.md). <br/> &ensp;&ensp;• DomainKeys identificadas Mail (DKIM). <br/> &ensp;&ensp;&ensp;&ensp;-Consulte [Verificação de uso de email no seu domínio personalizado no Office 365](https://docs.microsoft.com/office365/SecurityCompliance/use-dkim-to-validate-outbound-email). <br>&ensp;&ensp;&ensp;&ensp;-Depois que você configurou DKIM, habilitá-lo na segurança &amp; Centro de conformidade.<br/> &ensp;&ensp;• Autenticação de mensagem baseado no domínio, relatórios e conformidade (DMARC). </br> &ensp;&ensp;&ensp;&ensp;-Para DMARC setup [DMARC de uso para validar emails no Office 365](use-dmarc-to-validate-email.md).<br/>  <br/>
|
