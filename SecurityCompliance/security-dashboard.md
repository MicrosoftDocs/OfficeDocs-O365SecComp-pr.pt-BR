...
Se a assinatura de sua organização incluir [recursos de inteligência de ameaças](office-365-ti.md), o painel de segurança tem uma seção de inteligência de **ameaças** que inclui ferramentas avançadas. A equipe de segurança da sua organização pode usar as informações desta seção para entender campanhas emergentes, investigar ameaças e gerenciar incidentes. 
...
E, se a assinatura do Office 365 da sua organização incluir [recursos de inteligência de ameaças](office-365-ti.md), você também terá um relatório recente de alertas de gerenciamento de **ameaças** nesta seção que permite que sua equipe de segurança exiba e aja alertas de segurança de alta prioridade. 
