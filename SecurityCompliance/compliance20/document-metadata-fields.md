...
|Pontuação de relevância (problema)    | Sim (relevanceScore_issueNum)                   |                         | Sim           |
|Ler percentil (problema)    | Sim (readPercentile_issueNum)                   |                         | Sim          |
|Marca de relevância (problema)      | Sim (relevanceTag_issueNum)                     |                         | Sim           |
|||||
